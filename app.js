...
// --- FUNÇÃO PARA NOTIFICAÇÃO NATIVA (RESTAURADA) ---
...
// ==========================================================
// FUNÇÕES DE INTERFACE (SUA LÓGICA ORIGINAL)
// ==========================================================
...
// ==========================================================
// COMUNICAÇÃO MQTT (COM A CONEXÃO SEGURA 8084)
// ==========================================================
function onMessage(msg) {
    const topic = msg.destinationName;
    const val = msg.payloadString;

    // Alerta de Falha (Seu Modal)
    ...
    // Processamento de Tópicos (Exatamente como era antes)
    switch (topic) {
        case "smart_level/central/sistema": setText("sistema", val === "1" ? "1" : "0"); updatePowerButton(val); break;
        case "smart_level/central/retrolavagem": setText("retrolavagem", val === "1" ? "1" : "0"); break;
        case "smart_level/central/nivel": setText("nivel", val === "1" ? "1" : "0"); break;
...
function initMQTT() {
    ...
    client.connect({
        useSSL: true, // Obrigatório para GitHub Pages
