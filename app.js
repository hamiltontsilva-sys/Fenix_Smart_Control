...
// ==========================================================
// CLIENTES MQTT (IGUAL AO SEU FUNCIONAL)
// ==========================================================
const topicsA = [
...
// ==========================================================
// CONFIGURAÇÃO – CARREGA VALORES DO DASHBOARD
// ==========================================================
function carregarConfiguracaoDoDashboard() {

    const r = document.getElementById("rodizio_min");
    if (r) document.getElementById("cfg_rodizio").value = r.textContent;

    const ra = document.getElementById("retroA_status");
    if (ra) document.getElementById("cfg_retroA").value = ra.textContent;

    const rb = document.getElementById("retroB_status");
    if (rb) document.getElementById("cfg_retroB").value = rb.textContent;

    const pm = document.getElementById("poco_manual_sel");
    if (pm) document.getElementById("cfg_manual_poco").value = pm.textContent;
}

// 👉 ESTE EVENTO FAZ TUDO FUNCIONAR
document.getElementById("tabConfiguracao").addEventListener("click", () => {
